 ...
 *  parametro $rut
 *  debuelve rut si esta correcto
 */
function filtro_numerico($rut){
  if(ctype_digit($rut)==1){
    return($rut);
  }else{
   echo"<script>alert('Ingrese su rut nuevamente')</script>";
  }
}
